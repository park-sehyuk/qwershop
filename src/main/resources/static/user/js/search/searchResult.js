...
const productData = [
  {
    imageUrl: "../imges/printcottongucci.PNG",
    name: "프린트 코튼 저지 티셔츠",
    content: "구찌",
    price: "830000",
    category: "반팔",
  ...
  {
    imageUrl: "../imges/cottongucci.PNG",
    name: "자수 코튼 피케 폴로 셔츠",
    content: "구찌",
    price: "1160000",
    category: "반팔",
  ...
  {
    imageUrl: "../imges/polosweater.PNG",
  ...
  {
    imageUrl: "../imges/poloclassic.PNG",
    name: "클래식핏 리넨셔츠",
    content: "랄프로렌",
    price: "219000",
    category: "반팔",
  ...
  {
    imageUrl: "../imges/T-shirt1black.jpg",
  ...
  {
    imageUrl: "../imges/T-shirt2latte.jpg",
  ...
  {
    imageUrl: "../imges/T-shirt3fig.jpg",
  ...
  {
    imageUrl: "../imges/louisvuitton-white.png",
  ...
  {
    imageUrl: "../imges/burberry-white.png",
  ...
  {
    imageUrl: "../imges/balenciagablack.PNG",
  ...
  {
    imageUrl: "../imges/balenciagared.PNG",
  ...
  {
    imageUrl: "../imges/pradacotentshirt.PNG",
    name: "코튼 티셔츠",
    content: "프라다",
    price: "1550000",
    category: "반팔",
                    ...
                    <div class="imges-wrapper">
                        <a href="../production/detail.html?productName=${encodeURIComponent(
                          product.name
                            ...
                            <imges src="${product.imageUrl}" alt="${
        product.name
      }">
                        </a>
